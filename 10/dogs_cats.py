...
class DogsCats:
    ...
    def make_dataset_folders(self, subset_name, start_index, end_index):
        """
        Create dataset folders with images partitioned by categories.
        """
    ...
    def _make_dataset(self, subset_name):
        """
        Create a dataset using the Keras utility function.
        """
    ...
    def build_network(self, augmentation=True):
        """
        Build a CNN model with optional data augmentation layers.
        """
    ...
    def train(self, model_name):
        ...
        callbacks = [
            ...
            ModelCheckpoint(filepath=f'{model_name}.keras', save_best_only=True),
